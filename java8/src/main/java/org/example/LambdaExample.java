...
public class LambdaExample {
    ...
    public static void main(final String[] args) {
        ...
        Predicate<User> GreaterThan5 = new Predicate<User>() {
            @Override
            public boolean test(User user) {
                return user.age>5;
            }
        ...
        repository.select(GreaterThan5,SortByName);
        ...
        // TODO With functional interfaces declared
        Predicate<User> LessThan10 = new Predicate<User>() {
            @Override
            public boolean test(User user) {
                return user.age<10;
            }
        ...
        repository.select(LessThan10,SortByAge);
        ...
        // TODO With functional interfaces declared
        Predicate<User> UserActive = new Predicate<User>() {
            @Override
            public boolean test(User user) {
                return user.active;
            }
        ...
        // TODO With functional interfaces declared
        Predicate<User> ActiveAndGreaterThan8 = new Predicate<User>() {
            @Override
            public boolean test(User user) {
                return user.active&&user.age>8;
            }
        };
        repository.select(ActiveAndGreaterThan8,SortByName);
